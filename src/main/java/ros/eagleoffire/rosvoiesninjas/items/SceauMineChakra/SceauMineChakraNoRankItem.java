...
public class SceauMineChakraNoRankItem extends HangingEntityItem {
    public SceauMineChakraNoRankItem(EntityType<? extends HangingEntity> pType, Properties pProperties) {
        super(pType, pProperties);
    }
/*
    public SceauMineChakraNoRankItem(Properties pProperties) {
