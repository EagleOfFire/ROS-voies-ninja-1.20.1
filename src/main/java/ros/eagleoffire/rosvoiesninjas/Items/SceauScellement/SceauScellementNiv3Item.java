...
public class SceauScellementNiv3Item extends HangingEntityItem {
    public SceauScellementNiv3Item(EntityType<? extends HangingEntity> pType, Properties pProperties) {
        super(pType, pProperties);
    }

    public SceauScellementNiv3Item(Properties pProperties) {
   ...
   public InteractionResult useOn(UseOnContext pContext) {
         ...
         SceauScellementNiv3Entity hangingentity = new SceauScellementNiv3Entity(level, blockpos1, direction);
