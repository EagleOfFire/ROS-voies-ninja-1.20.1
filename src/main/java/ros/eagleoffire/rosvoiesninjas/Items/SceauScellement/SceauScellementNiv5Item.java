...
public class SceauScellementNiv5Item extends HangingEntityItem {
    public SceauScellementNiv5Item(EntityType<? extends HangingEntity> pType, Properties pProperties) {
        super(pType, pProperties);
    }

    public SceauScellementNiv5Item(Properties pProperties) {
   ...
   public InteractionResult useOn(UseOnContext pContext) {
         ...
         SceauScellementNiv5Entity hangingentity = new SceauScellementNiv5Entity(level, blockpos1, direction);
