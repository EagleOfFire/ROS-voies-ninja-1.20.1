...
public class SceauScellementNiv4Item extends HangingEntityItem {
    public SceauScellementNiv4Item(EntityType<? extends HangingEntity> pType, Properties pProperties) {
        super(pType, pProperties);
    }

    public SceauScellementNiv4Item(Properties pProperties) {
   ...
   public InteractionResult useOn(UseOnContext pContext) {
         ...
         SceauScellementNiv4Entity hangingentity = new SceauScellementNiv4Entity(level, blockpos1, direction);
