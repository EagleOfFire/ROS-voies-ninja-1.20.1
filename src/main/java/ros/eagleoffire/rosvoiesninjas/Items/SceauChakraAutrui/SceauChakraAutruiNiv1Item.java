...
public class SceauChakraAutruiNiv1Item extends HangingEntityItem {
    public SceauChakraAutruiNiv1Item(EntityType<? extends HangingEntity> pType, Properties pProperties) {
        super(pType, pProperties);
    }

    public SceauChakraAutruiNiv1Item(Properties pProperties) {
   ...
   public InteractionResult useOn(UseOnContext pContext) {
         ...
         SceauChakraAutruiNiv1Entity hangingentity = new SceauChakraAutruiNiv1Entity(level, blockpos1, direction);
