...
public class SceauChakraAutruiNiv2Item extends HangingEntityItem {
    public SceauChakraAutruiNiv2Item(EntityType<? extends HangingEntity> pType, Properties pProperties) {
        super(pType, pProperties);
    }

    public SceauChakraAutruiNiv2Item(Properties pProperties) {
   ...
   public InteractionResult useOn(UseOnContext pContext) {
         ...
         SceauChakraAutruiNiv2Entity hangingentity = new SceauChakraAutruiNiv2Entity(level, blockpos1, direction);
