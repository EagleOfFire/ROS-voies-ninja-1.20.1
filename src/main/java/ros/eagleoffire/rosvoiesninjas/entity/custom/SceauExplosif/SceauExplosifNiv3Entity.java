...
public class SceauExplosifNiv3Entity extends HangingEntity {
   private static final Logger LOGGER = LogUtils.getLogger();
   private static final EntityDataAccessor<ItemStack> DATA_ITEM = SynchedEntityData.defineId(SceauExplosifNiv3Entity.class, EntityDataSerializers.ITEM_STACK);
   private static final EntityDataAccessor<Integer> DATA_ROTATION = SynchedEntityData.defineId(SceauExplosifNiv3Entity.class, EntityDataSerializers.INT);
   public static final int NUM_ROTATIONS = 8;
   private float dropChance = 1.0F;
   private boolean fixed;

   public SceauExplosifNiv3Entity(EntityType<? extends HangingEntity> pEntityType, Level pLevel) {
      super(pEntityType, pLevel);
   }

   public SceauExplosifNiv3Entity(Level pLevel, BlockPos pPos, Direction pFacingDirection) {
      this(ModEntities.SCEAU_EXPLOSIF_NIV3.get(), pLevel, pPos, pFacingDirection);
   }

   public SceauExplosifNiv3Entity(EntityType<? extends SceauExplosifNiv3Entity> pEntityType, Level pLevel, BlockPos pPos, Direction pDirection) {
   ...
   public SlotAccess getSlot(int pSlot) {
      return pSlot == 0 ? new SlotAccess() {
         public ItemStack get() {
            return SceauExplosifNiv3Entity.this.getItem();
         }

         public boolean set(ItemStack p_149635_) {
            SceauExplosifNiv3Entity.this.setItem(p_149635_);
            return true;
         }
      } : super.getSlot(pSlot);
   }
