...
public class SceauChakraAutruiEntity extends HangingEntity {
   ...
   private static final EntityDataAccessor<ItemStack> DATA_ITEM = SynchedEntityData.defineId(SceauChakraAutruiEntity.class, EntityDataSerializers.ITEM_STACK);
   private static final EntityDataAccessor<Integer> DATA_ROTATION = SynchedEntityData.defineId(SceauChakraAutruiEntity.class, EntityDataSerializers.INT);
   public static final int NUM_ROTATIONS = 8;
   private float dropChance = 1.0F;
   private boolean fixed;

   public SceauChakraAutruiEntity(EntityType<? extends HangingEntity> pEntityType, Level pLevel) {
