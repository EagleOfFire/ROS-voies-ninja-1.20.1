...
public class SceauScellementNiv1Entity extends HangingEntity {
   private static final Logger LOGGER = LogUtils.getLogger();
   private static final EntityDataAccessor<ItemStack> DATA_ITEM = SynchedEntityData.defineId(SceauScellementNiv1Entity.class, EntityDataSerializers.ITEM_STACK);
   private static final EntityDataAccessor<Integer> DATA_ROTATION = SynchedEntityData.defineId(SceauScellementNiv1Entity.class, EntityDataSerializers.INT);
   public static final int NUM_ROTATIONS = 8;
   private float dropChance = 1.0F;
   private boolean fixed;

   public SceauScellementNiv1Entity(EntityType<? extends HangingEntity> pEntityType, Level pLevel) {
      super(pEntityType, pLevel);
   }

   public SceauScellementNiv1Entity(Level pLevel, BlockPos pPos, Direction pFacingDirection) {
      this(ModEntities.SCEAU_SCELLEMENT_NIV1.get(), pLevel, pPos, pFacingDirection);
   }

   public SceauScellementNiv1Entity(EntityType<? extends SceauScellementNiv1Entity> pEntityType, Level pLevel, BlockPos pPos, Direction pDirection) {
   ...
   public SlotAccess getSlot(int pSlot) {
      return pSlot == 0 ? new SlotAccess() {
         public ItemStack get() {
            return SceauScellementNiv1Entity.this.getItem();
         }

         public boolean set(ItemStack p_149635_) {
            SceauScellementNiv1Entity.this.setItem(p_149635_);
            return true;
         }
      } : super.getSlot(pSlot);
   }
