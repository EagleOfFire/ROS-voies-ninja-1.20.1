...
public class SceauScellementNiv3Entity extends HangingEntity {
   private static final Logger LOGGER = LogUtils.getLogger();
   private static final EntityDataAccessor<ItemStack> DATA_ITEM = SynchedEntityData.defineId(SceauScellementNiv3Entity.class, EntityDataSerializers.ITEM_STACK);
   private static final EntityDataAccessor<Integer> DATA_ROTATION = SynchedEntityData.defineId(SceauScellementNiv3Entity.class, EntityDataSerializers.INT);
   public static final int NUM_ROTATIONS = 8;
   private float dropChance = 1.0F;
   private boolean fixed;

   public SceauScellementNiv3Entity(EntityType<? extends HangingEntity> pEntityType, Level pLevel) {
      super(pEntityType, pLevel);
   }

   public SceauScellementNiv3Entity(Level pLevel, BlockPos pPos, Direction pFacingDirection) {
      this(ModEntities.SCEAU_SCELLEMENT_NIV3.get(), pLevel, pPos, pFacingDirection);
   }

   public SceauScellementNiv3Entity(EntityType<? extends SceauScellementNiv3Entity> pEntityType, Level pLevel, BlockPos pPos, Direction pDirection) {
   ...
   public SlotAccess getSlot(int pSlot) {
      return pSlot == 0 ? new SlotAccess() {
         public ItemStack get() {
            return SceauScellementNiv3Entity.this.getItem();
         }

         public boolean set(ItemStack p_149635_) {
            SceauScellementNiv3Entity.this.setItem(p_149635_);
            return true;
         }
      } : super.getSlot(pSlot);
   }
