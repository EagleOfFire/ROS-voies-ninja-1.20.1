package ros.eagleoffire.rosvoiesninjas.entity.custom.SceauChakra;
...
public class SceauChakraNiv0Entity extends HangingEntity {
   private static final Logger LOGGER = LogUtils.getLogger();
   private static final EntityDataAccessor<ItemStack> DATA_ITEM = SynchedEntityData.defineId(SceauChakraNiv0Entity.class, EntityDataSerializers.ITEM_STACK);
   private static final EntityDataAccessor<Integer> DATA_ROTATION = SynchedEntityData.defineId(SceauChakraNiv0Entity.class, EntityDataSerializers.INT);
   public static final int NUM_ROTATIONS = 8;
   private float dropChance = 1.0F;
   private boolean fixed;

   public SceauChakraNiv0Entity(EntityType<? extends HangingEntity> pEntityType, Level pLevel) {
      super(pEntityType, pLevel);
   }

   public SceauChakraNiv0Entity(Level pLevel, BlockPos pPos, Direction pFacingDirection) {
      this(ModEntities.SCEAU_CHAKRA_NIV0.get(), pLevel, pPos, pFacingDirection);
   }

   public SceauChakraNiv0Entity(EntityType<? extends SceauChakraNiv0Entity> pEntityType, Level pLevel, BlockPos pPos, Direction pDirection) {
   ...
   public SlotAccess getSlot(int pSlot) {
      return pSlot == 0 ? new SlotAccess() {
         public ItemStack get() {
            return SceauChakraNiv0Entity.this.getItem();
         }

         public boolean set(ItemStack p_149635_) {
            SceauChakraNiv0Entity.this.setItem(p_149635_);
            return true;
         }
      } : super.getSlot(pSlot);
   }
   ...
   public InteractionResult interact(Player pPlayer, InteractionHand pHand) {
        ...
        if (ClientFuinjutsuData.get_LVL() > 0) {
           DistExecutor.unsafeRunWhenOn(Dist.CLIENT, () -> () -> ClientHooks.openSceauChakraScreen(pPlayer, this));
        }else {
