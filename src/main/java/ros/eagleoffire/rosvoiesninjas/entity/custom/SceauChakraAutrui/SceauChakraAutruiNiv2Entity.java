...
public class SceauChakraAutruiNiv2Entity extends HangingEntity {
   private static final Logger LOGGER = LogUtils.getLogger();
   private static final EntityDataAccessor<ItemStack> DATA_ITEM = SynchedEntityData.defineId(SceauChakraAutruiNiv2Entity.class, EntityDataSerializers.ITEM_STACK);
   private static final EntityDataAccessor<Integer> DATA_ROTATION = SynchedEntityData.defineId(SceauChakraAutruiNiv2Entity.class, EntityDataSerializers.INT);
   public static final int NUM_ROTATIONS = 8;
   private float dropChance = 1.0F;
   private boolean fixed;

   public SceauChakraAutruiNiv2Entity(EntityType<? extends HangingEntity> pEntityType, Level pLevel) {
      super(pEntityType, pLevel);
   }

   public SceauChakraAutruiNiv2Entity(Level pLevel, BlockPos pPos, Direction pFacingDirection) {
      this(ModEntities.SCEAU_CHAKRA_AUTRUI_NIV2.get(), pLevel, pPos, pFacingDirection);
   }

   public SceauChakraAutruiNiv2Entity(EntityType<? extends SceauChakraAutruiNiv2Entity> pEntityType, Level pLevel, BlockPos pPos, Direction pDirection) {
   ...
   public SlotAccess getSlot(int pSlot) {
      return pSlot == 0 ? new SlotAccess() {
         public ItemStack get() {
            return SceauChakraAutruiNiv2Entity.this.getItem();
         }

         public boolean set(ItemStack p_149635_) {
            SceauChakraAutruiNiv2Entity.this.setItem(p_149635_);
            return true;
         }
      } : super.getSlot(pSlot);
   }
