...
public class SceauChakraAutruiNiv4Entity extends HangingEntity {
   private static final Logger LOGGER = LogUtils.getLogger();
   private static final EntityDataAccessor<ItemStack> DATA_ITEM = SynchedEntityData.defineId(SceauChakraAutruiNiv4Entity.class, EntityDataSerializers.ITEM_STACK);
   private static final EntityDataAccessor<Integer> DATA_ROTATION = SynchedEntityData.defineId(SceauChakraAutruiNiv4Entity.class, EntityDataSerializers.INT);
   public static final int NUM_ROTATIONS = 8;
   private float dropChance = 1.0F;
   private boolean fixed;

   public SceauChakraAutruiNiv4Entity(EntityType<? extends HangingEntity> pEntityType, Level pLevel) {
      super(pEntityType, pLevel);
   }

   public SceauChakraAutruiNiv4Entity(Level pLevel, BlockPos pPos, Direction pFacingDirection) {
      this(ModEntities.SCEAU_CHAKRA_AUTRUI_NIV4.get(), pLevel, pPos, pFacingDirection);
   }

   public SceauChakraAutruiNiv4Entity(EntityType<? extends SceauChakraAutruiNiv4Entity> pEntityType, Level pLevel, BlockPos pPos, Direction pDirection) {
   ...
   public SlotAccess getSlot(int pSlot) {
      return pSlot == 0 ? new SlotAccess() {
         public ItemStack get() {
            return SceauChakraAutruiNiv4Entity.this.getItem();
         }

         public boolean set(ItemStack p_149635_) {
            SceauChakraAutruiNiv4Entity.this.setItem(p_149635_);
            return true;
         }
      } : super.getSlot(pSlot);
   }
