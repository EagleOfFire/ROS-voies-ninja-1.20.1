...
public class SceauChakraNiv1Model<T extends HangingEntity> extends EntityModel<T> {
public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(ROSVoiesNinjas.MODID, "sceau_chakra_niv1"), "main");
	private final ModelPart bb_main;
	public SceauChakraNiv1Model(ModelPart root) {
