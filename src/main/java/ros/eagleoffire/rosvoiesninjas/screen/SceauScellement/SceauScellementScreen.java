package ros.eagleoffire.rosvoiesninjas.screen.SceauScellement;
...
public class SceauScellementScreen extends Screen {
    private static final Component TITLE =
            Component.translatable("gui." + ROSVoiesNinjas.MODID + ".sceau_Scellement_screen");
    ...
    private void renderBackGround(GuiGraphics graphics) {
        if (ClientFuinjutsuData.get_LVL() == 1) {
            graphics.blit(ScreenRessourceLocation.SCELLEMENT_TEXTURE_NIV1, 0, 0, 0, 0, this.imageWidth, this.imageHeight, this.width, this.height);
        } else if (ClientFuinjutsuData.get_LVL() == 2) {
            graphics.blit(ScreenRessourceLocation.SCELLEMENT_TEXTURE_NIV2, 0, 0, 0, 0, this.imageWidth, this.imageHeight, this.width, this.height);
        } else if (ClientFuinjutsuData.get_LVL() == 3) {
            graphics.blit(ScreenRessourceLocation.SCELLEMENT_TEXTURE_NIV3, 0, 0, 0, 0, this.imageWidth, this.imageHeight, this.width, this.height);
        } else if (ClientFuinjutsuData.get_LVL() == 4) {
            graphics.blit(ScreenRessourceLocation.SCELLEMENT_TEXTURE_NIV4, 0, 0, 0, 0, this.imageWidth, this.imageHeight, this.width, this.height);
        } else if (ClientFuinjutsuData.get_LVL() == 5) {
            graphics.blit(ScreenRessourceLocation.SCELLEMENT_TEXTURE_NIV5, 0, 0, 0, 0, this.imageWidth, this.imageHeight, this.width, this.height);
        }
    }
    ...
    private void renderTransition(GuiGraphics graphics) {
        ...
        graphics.blit(ScreenRessourceLocation.SCELLEMENT_PROGRESS_NIV0, 0, 0, 0, 0, this.imageWidth, this.imageHeight, this.width, this.height);
        ...
        if (delta>(deltas[index])){
            ...
            graphics.blit(ScreenRessourceLocation.SCELLEMENT_SCEAU_NIV1, 0, (int)(0.287*this.imageHeight), 0, (int)(0.287*this.imageHeight), this.imageWidth, getDrawingProgress(0,300,this.imageHeight/2), this.width, this.height);
            renderProgress(graphics, maxProgress);
        }else if (deltas[1] >= delta) {
            graphics.blit(ScreenRessourceLocation.SCELLEMENT_SCEAU_NIV1, 0, (int)(0.287*this.imageHeight), 0, (int)(0.287*this.imageHeight), this.imageWidth, this.imageHeight, this.width, this.height);
            graphics.blit(ScreenRessourceLocation.SCELLEMENT_SCEAU_NIV2, 0, (int)(0.287*this.imageHeight), 0, (int)(0.287*this.imageHeight), this.imageWidth, getDrawingProgress(1,300,this.imageHeight/2), this.width, this.height);
            renderProgress(graphics, maxProgress);
        }else if (deltas[2] >= delta) {
            graphics.blit(ScreenRessourceLocation.SCELLEMENT_SCEAU_NIV2, 0, (int)(0.287*this.imageHeight), 0, (int)(0.287*this.imageHeight), this.imageWidth, this.imageHeight, this.width, this.height);
            graphics.blit(ScreenRessourceLocation.SCELLEMENT_SCEAU_NIV3, 0, (int)(0.287*this.imageHeight), 0, (int)(0.287*this.imageHeight), this.imageWidth, getDrawingProgress(2,300,this.imageHeight/3), this.width, this.height);
            renderProgress(graphics, maxProgress);
        }else if (deltas[3] >= delta) {
            graphics.blit(ScreenRessourceLocation.SCELLEMENT_SCEAU_NIV3, 0, (int)(0.287*this.imageHeight), 0, (int)(0.287*this.imageHeight), this.imageWidth, this.imageHeight, this.width, this.height);
            graphics.blit(ScreenRessourceLocation.SCELLEMENT_SCEAU_NIV4, 0, (int)(0.287*this.imageHeight), 0, (int)(0.287*this.imageHeight), this.imageWidth, getDrawingProgress(3,300,this.imageHeight/3), this.width, this.height);
            renderProgress(graphics, maxProgress);
        }else if (deltas[4] >= delta) {
            graphics.blit(ScreenRessourceLocation.SCELLEMENT_SCEAU_NIV4, 0, (int)(0.287*this.imageHeight), 0, (int)(0.287*this.imageHeight), this.imageWidth, this.imageHeight, this.width, this.height);
            graphics.blit(ScreenRessourceLocation.SCELLEMENT_SCEAU_NIV5, 0, (int)(0.287*this.imageHeight), 0, (int)(0.287*this.imageHeight), this.imageWidth, getDrawingProgress(4,300,this.imageHeight/3), this.width, this.height);
            renderProgress(graphics, maxProgress);
        }else {
            graphics.blit(ScreenRessourceLocation.SCELLEMENT_SCEAU_NIV5, 0, (int)(0.287*this.imageHeight), 0, (int)(0.287*this.imageHeight), this.imageWidth, this.imageHeight, this.width, this.height);
            graphics.blit(ScreenRessourceLocation.SCELLEMENT_SCEAU_NIV6, 0, (int)(0.287*this.imageHeight), 0, (int)(0.287*this.imageHeight), this.imageWidth, getDrawingProgress(5,300,this.imageHeight/3), this.width, this.height);
            renderProgress(graphics, maxProgress);
        }
    }
    ...
    private void creationResult() {
        ModMessages.sendToServer(new GiveSceauC2SPacket("Scellement", this.transition));
        this.SE0E.kill();
